  ...
  const contactMethods = [
    {
      ...
      title: 'Email',
      value: 'sidikouzekaba@gmail.com',
      link: 'mailto:sidikouzekaba@gmail.com'
    },
    {
      icon: (
      ...
      title: 'WhatsApp',
      value: '+224 661 862 044',
      link: 'https://wa.me/224661862044'
    }
  ]
            ...
            <div className="space-y-6">
              {contactMethods.map((method, i) => (
                <a
                  ...
                  className="card flex items-center gap-4 p-4 hover:border-guinea-red"
                >
                  <div className="flex h-12 w-12 items-center justify-center rounded-xl bg-guinea-red/10 text-guinea-red">
                    {method.icon}
                  </div>
                  <div>
              ...
              <div className="card flex items-center gap-4 p-4">
                <div className="flex h-12 w-12 items-center justify-center rounded-xl bg-guinea-yellow/10 text-guinea-yellow">
                  <svg className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                ...
                <div>
                  <p className="font-semibold text-zinc-900 dark:text-white">Adresse</p>
                  <p className="text-zinc-600 dark:text-zinc-400">Conakry, Guinée</p>
                </div>
              </div>
            </div>
