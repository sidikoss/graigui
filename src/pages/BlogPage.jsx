...
const articles = [
  {
    id: 1,
    title: 'Guide Complet pour Choisir vos Craies Scolaires en Guinée',
    excerpt: 'Tout ce que vous devez savoir pour sélectionner les meilleures craies pour votre établissement.',
    category: 'Guide',
    readTime: '5 min',
    date: '15 Mars 2024'
  },
  {
    id: 2,
    title: 'Pourquoi les Craies Importées ne Conviennent pas au Climat Guinéen',
    excerpt: 'Les spécificités du climat local exigent des craies adaptées. Découvrez pourquoi.',
    category: 'Astuces',
    readTime: '4 min',
    date: '8 Mars 2024'
  },
  {
    id: 3,
    title: 'Comment Économiser sur vos Fournitures Scolaires en 2024',
    excerpt: 'Conseils pratiques pour réduire le budget fournitures sans compromettre la qualité.',
    category: 'Économie',
    readTime: '6 min',
    date: '1er Mars 2024'
  },
  {
    id: 4,
    title: 'L\'Histoire de la Fabrication de Craies en Afrique de l\'Ouest',
    excerpt: 'Plongez dans l\'histoire fascinante de la craie et son importance dans l\'éducation.',
    category: 'Histoire',
    readTime: '8 min',
  ...
  {
    id: 5,
    title: 'Soutenir la Fabrication Locale : Pourquoi c\'Est Important',
    excerpt: 'Comment vos achats peuvent aider l\'économie guinéenne et créer des emplois.',
    category: 'Économie',
    readTime: '4 min',
      ...
      <section className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="grid gap-8 md:grid-cols-2 lg:grid-cols-3">
          {articles.map((article) => (
            <article key={article.id} className="card overflow-hidden group cursor-pointer">
      ...
      <section className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="rounded-2xl bg-zinc-100 p-8 dark:bg-zinc-900">
          ...
          <div className="flex flex-wrap justify-center gap-3">
            {[
              'craies scolaires guinée', 
              'achat craies écoles conakry', 
              'fournisseur craies qualité',
              'prix craies scolaires',
              'livraison craies guinée',
              'grossiste fournitures scolaires'
            ].map((tag, i) => (
